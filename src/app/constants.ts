...
export class Constants {
    ...
    public wiseWellsEndpoint = 'https://gis.deq.wyoming.gov/arcgis_443/rest/services/WISE_WELLS/MapServer';
    public recreationEndpoint = 'https://gis.deq.wyoming.gov/arcgis_443/rest/services/recreation1/MapServer';
